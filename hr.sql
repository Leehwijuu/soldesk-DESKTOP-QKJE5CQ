...
--			   해당갑이 0 이면 0.0/ 1, 0.09/ 2, 0.20/ 3, 0.30/ 4, 0.40/ 5, 0.42 / 6, 0.44/ 그 외 0.45
SELECT 
	E.LAST_NAME, 
	E.SALARY, 
...
-- 도시 이름이 T로 시작하는 지역에서 사는 사원들의 정보 조회
-- 사원번호, 이름(LAST_NAME), 부서번호, 지역명
-- EMPLOYYS, DEPARTMENT, LOCATIONS 조인
SELECT
	E.EMPLOYEE_ID,
	E.LAST_NAME,
	E.DEPARTMENT_ID,
...
-- 부서번호, FIRST_NAME과 LAST_NAME 을 연결하여 출력, 급여, 입사일 출력
-- EMPLOYYS SELF 조인
